...
func (m *defaultUsersModel) Insert(ctx context.Context, data *Users) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Nickname, data.Mobile, data.Password, data.Avatar, data.Sex, data.Status, data.Intro)
	}, usersIdKey, usersMobileKey)
	return ret, err
}
...
func (m *defaultUsersModel) Update(ctx context.Context, newData *Users) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Nickname, newData.Mobile, newData.Password, newData.Avatar, newData.Sex, newData.Status, newData.Intro, newData.Id)
	}, usersIdKey, usersMobileKey)
	return err
}
